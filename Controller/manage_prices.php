				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><input type="text" class='form-controm-xs number text-right' name="cabin[<?php echo $row['id'] ?>]" value="<?php echo isset($arr['cabin_price']) ? $arr['cabin_price'] : '' ?>"></td>
							<td><input type="text" class='form-controm-xs number text-right' name="seat[<?php echo $row['id'] ?>]" value="<?php echo isset($arr['seat_price']) ? $arr['seat_price'] : '' ?>"></td>
							<td><input type="text" class='form-controm-xs number text-right' name="berth[<?php echo $row['id'] ?>]" value="<?php echo isset($arr['berth_price']) ? $arr['berth_price'] : '' ?>"></td>
						</tr>
					<?php endwhile; ?>
				</tbody>
			</table>

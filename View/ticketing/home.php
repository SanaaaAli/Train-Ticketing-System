              ...
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex">
                      <span class="btn btn-sm btn-secondary btn-minus"><b><i class="fa fa-minus"></i></b></span>
                        <input type="number" name="seat[1]" class="form-control-xs seat" value="0">
                  ...
                  <td>
                    ...
                    <small class="price" id="price_cabin"></small>
                  </td>
                  <td>
                    <p class="text-right amount" id="amount_cabin">0.00</p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div class="d-flex">
                      <span class="btn btn-sm btn-secondary btn-minus"><b><i class="fa fa-minus"></i></b></span>
                        <input type="number" name="seat[2]" class="form-control-xs seat" value="0">
                      <span class="btn btn-sm btn-secondary btn-plus"><b><i class="fa fa-plus"></i></b></span>
                    </div>
                  </td>
                  <td>
                    ...
                    <small class="price" id="price_seat"></small>
                  </td>
                  <td>
                    <p class="text-right amount" id="amount_seat">0.00</p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div class="d-flex">
                      <span class="btn btn-sm btn-secondary btn-minus"><b><i class="fa fa-minus"></i></b></span>
                        <input type="number" name="seat[3]" class="form-control-xs seat" value="0">
                      <span class="btn btn-sm btn-secondary btn-plus"><b><i class="fa fa-plus"></i></b></span>
                    </div>
                  </td>
                  <td>
                    ...
                    <small class="price" id="price_berth"></small>
                  </td>
                  <td>
                    <p class="text-right amount" id="amount_berth">0.00</p>
                  </td>
                </tr>
              </tbody>
              <tfoot>
...
<script>
      ...
      $.ajax({
        ...
        success:function(resp){
          if(resp){
            ...
            $('[name="price[1]"]').val(parseFloat(resp.cabin_price).toLocaleString('en-US',{style:'decimal',minimumFractionDigits:2,maximumFractionDigits:2}))
            $('[name="price[2]"]').val(parseFloat(resp.seat_price).toLocaleString('en-US',{style:'decimal',minimumFractionDigits:2,maximumFractionDigits:2}))
            $('[name="price[3]"]').val(parseFloat(resp.berth_price).toLocaleString('en-US',{style:'decimal',minimumFractionDigits:2,maximumFractionDigits:2}))
            $('#price_cabin').text(parseFloat(resp.cabin_price).toLocaleString('en-US',{style:'decimal',minimumFractionDigits:2,maximumFractionDigits:2}))
            $('#price_seat').text(parseFloat(resp.seat_price).toLocaleString('en-US',{style:'decimal',minimumFractionDigits:2,maximumFractionDigits:2}))
            $('#price_berth').text(parseFloat(resp.berth_price).toLocaleString('en-US',{style:'decimal',minimumFractionDigits:2,maximumFractionDigits:2}))
   ...
   $("#pay_now").click(function(){
    ...
    if(amount <= 0){
        alert_toast("Please add passenger first.",'danger')
        end_load()
        return false;
    }
